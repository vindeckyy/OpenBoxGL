...
OpenBox tracks LaunchBox feature parity for Linux environments. For contribution and release workflow, see [CONTRIBUTING.md](CONTRIBUTING.md) and [CHANGELOG.md](CHANGELOG.md). The latest release is **v0.4.6**, hardening POST API validation, expanding real-HTTP boundary regressions, and refreshing project identity and support documentation.

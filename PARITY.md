...
OpenBox tracks LaunchBox feature parity for Linux environments. For contribution and release workflow, see [CONTRIBUTING.md](CONTRIBUTING.md) and [CHANGELOG.md](CHANGELOG.md). The latest release is **v0.4.5**, adding saved filter presets, deep links, granular backups, process tracking, IGDB lookup, and YAML emulator definitions.

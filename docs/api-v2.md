...
Generated from `routes.py` and `contracts.py`; do not edit by hand. v2 rows also include `@route` decorator registrations from `routes/registry.py`. Regenerate with `python3 scripts/gen_api_docs.py`.
...
| GET | `/api/v2/collections/export` | `handlers.collections.collections_export` |
| POST | `/api/v2/collections/import` | `handlers.collections.collections_import` |
| GET | `/api/v2/emulators/defs/channel` | `_api_get_api_v2_emulators_defs_channel` |
| POST | `/api/v2/emulators/defs/channel/update` | `_api_post_api_v2_emulators_defs_channel_update` |
...
| GET | `/api/v2/household/activity` | `handlers.household.household_activity` |
...
| GET | `/api/v2/household/challenge/weekly` | `handlers.household.household_weekly_challenge` |
| POST | `/api/v2/household/challenge/weekly` | `handlers.household.household_weekly_adopt` |
...
| POST | `/api/v2/household/presence` | `handlers.household.household_presence` |
| POST | `/api/v2/household/presence/heartbeat` | `handlers.household.household_heartbeat` |
...
| GET | `/api/v2/household/wishlist` | `handlers.household.household_wishlist` |
| POST | `/api/v2/household/wishlist` | `handlers.household.household_wishlist_share` |
...
| GET | `/api/v2/moments/auto-suggest` | `handlers.moments.moments_auto_suggest` |
...
| GET | `/api/v2/party/decks` | `_api_get_api_v2_party_decks` |
| POST | `/api/v2/party/decks` | `_api_post_api_v2_party_decks` |
| POST | `/api/v2/party/decks/delete` | `_api_post_api_v2_party_decks_delete` |
| POST | `/api/v2/party/decks/import` | `_api_post_api_v2_party_decks_import` |
| POST | `/api/v2/party/decks/load` | `_api_post_api_v2_party_decks_load` |
| POST | `/api/v2/party/decks/share` | `_api_post_api_v2_party_decks_share` |
...
| GET | `/api/v2/saves/history` | `_api_get_api_v2_saves_history` |
| POST | `/api/v2/saves/history/prune` | `_api_post_api_v2_saves_history_prune` |
| POST | `/api/v2/saves/history/restore` | `_api_post_api_v2_saves_history_restore` |
| POST | `/api/v2/saves/history/test-restore` | `_api_post_api_v2_saves_history_test_restore` |
| POST | `/api/v2/saves/history/verify` | `_api_post_api_v2_saves_history_verify` |
...
| GET | `/api/v2/sessions/export` | `_api_get_api_v2_sessions_export` |
| GET | `/api/v2/sessions/recap` | `_api_get_api_v2_sessions_recap` |
| GET | `/api/v2/setup/checklists` | `_api_get_api_v2_setup_checklists` |
...
| GET | `/api/v2/timemachine/compare` | `_api_get_api_v2_timemachine_compare` |
| POST | `/api/v2/update/download` | `_api_post_api_v2_update_download` |
| GET | `/api/v2/update/download/status` | `_api_get_api_v2_update_download_status` |

_150 routes._

## API v1 (frozen)

The v1 surface is the stable contract. Legacy `/api/*` paths stay available for older clients; additive feature work targets `/api/v2/*` so the frozen v1 contract does not drift. Public assets and byte/stream endpoints follow their route-specific behavior, and not every legacy error has the full `error`, `code`, and `request_id` envelope.

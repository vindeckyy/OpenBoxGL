...
- **CPU architecture:** OpenBox 1.13.0 publishes signed **x86_64 and aarch64 AppImages**. The Flatpak bundle is **x86_64 only**. The in-app updater and the release installer select the artifact that matches the running architecture and refuse a mismatched or unsigned artifact.

...
GET_TABLE = {
    ...
    "/api/v2/emulators/defs/status": "handlers.defs._api_get_api_v2_emulators_defs_status",
    "/api/v2/emulators/defs/update": "handlers.defs._api_get_api_v2_emulators_defs_update",
    ...
    "/api/v2/metadata/media-candidates": "_api_get_api_v2_metadata_media_candidates",
    "/api/v2/metadata/scrape-settings": "handlers.metadata._api_get_api_v2_metadata_scrape_settings",
    ...
    "/api/v2/insights/radio": "_api_get_api_v2_insights_radio",
    "/api/v2/insights/radar": "_api_get_api_v2_insights_radar",
    "/api/v2/insights/trophies": "_api_get_api_v2_insights_trophies",
    ...
    "/api/v2/library/dna/status": "_api_get_api_v2_library_dna_status",
    ...
    "/api/v2/plugins/settings": "_api_get_api_v2_plugins_settings",
    "/api/v2/plugins/catalog": "_api_get_api_v2_plugins_catalog",
    ...
    "/api/v2/library/health": "handlers.library_health.health_snapshot",
    "/api/v2/library/health/issues": "handlers.library_health.health_issues",
    ...
    "/api/v2/memories": "_api_get_api_v2_memories",
    "/api/v2/memories/status": "_api_get_api_v2_memories_status",
    "/api/v2/memories/media": "_api_get_api_v2_memories_media",
    ...
    "/static/recap.js": "_api_get_static",
    ...
    "/static/timemachine.js": "_api_get_static",
    "/static/moments.js": "_api_get_static",
    "/static/palette.js": "_api_get_static",
    "/static/arcaderoom.js": "_api_get_static",
    "/static/household.js": "_api_get_static",
    "/static/clips.js": "_api_get_static",
    "/static/whatsnew.js": "_api_get_static",
...
POST_TABLE = {
    ...
    "/api/import/epic": "_api_post_api_import_epic",
    ...
    "/api/v2/insights/radio/refresh": "_api_post_api_v2_insights_radio_refresh",
    "/api/v2/insights/radar/park": "_api_post_api_v2_insights_radar_park",
    ...
    "/api/v2/library/dna/search": "_api_post_api_v2_library_dna_search",
    "/api/v2/library/dna/index/rebuild": "_api_post_api_v2_library_dna_index_rebuild",
    ...
    "/api/v2/import/esde/preview": "_api_post_api_v2_import_esde_preview",
    "/api/v2/import/esde/apply": "_api_post_api_v2_import_esde_apply",
    ...
    "/api/v2/plugins/trust": "_api_post_api_v2_plugins_trust",
    "/api/v2/plugins/permissions": "_api_post_api_v2_plugins_permissions",
    "/api/v2/plugins/settings": "_api_post_api_v2_plugins_settings",
    ...
    "/api/v2/library/trash/purge": "_api_post_api_v2_library_trash_purge",
    "/api/v2/library/sync/preview": "_api_post_api_v2_library_sync_preview",
    ...
    "/api/v2/steamgrid/apply": "handlers.steamgrid.steamgrid_apply",
    ...
    "/api/v2/library/health/scan": "handlers.library_health.health_scan",
    "/api/v2/library/health/fix": "handlers.library_health.health_fix",
    "/api/v2/library/health/undo": "handlers.library_health.health_undo",
    ...
    "/api/v2/steambridge/remove": "handlers.steambridge.steambridge_remove",
    ...
    "/api/v2/metadata/auto-scrape": "handlers.metadata.metadata_auto_scrape",
    "/api/v2/metadata/scrape-settings": "handlers.metadata._api_post_api_v2_metadata_scrape_settings",
    "/api/v2/memories/import": "_api_post_api_v2_memories_import",
    "/api/v2/resume": "handlers.resume.resume_launch",
    "/api/v2/resume/discard": "handlers.resume.resume_discard",
    "/api/v2/moments": "handlers.moments.moments_create",
    "/api/v2/collections": "handlers.collections.collections_save",
    "/api/v2/emulators/defs/update": "handlers.defs._api_post_api_v2_emulators_defs_update",
    "/api/v2/emulators/defs/rollback": "handlers.defs._api_post_api_v2_emulators_defs_rollback",
    ...
    "/api/v2/reels/create": "handlers.clips.create_reel_job",
    "/api/v2/arcade/kiosk/pin": "handlers.arcade.kiosk_pin",
    "/api/v2/arcade/kiosk/verify": "handlers.arcade.kiosk_verify",
    "/api/v2/insights/trophies/evaluate": "_api_post_api_v2_insights_trophies_evaluate",

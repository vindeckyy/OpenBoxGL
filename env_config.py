...
ENV_KEYS = frozenset({
    ...
    "SCREENSCRAPER_USER", "OPENBOX_SCREENSCRAPER_USER",
    "SCREENSCRAPER_PASSWORD", "OPENBOX_SCREENSCRAPER_PASSWORD",
    "SCREENSCRAPER_DEV_ID", "OPENBOX_SCREENSCRAPER_DEV_ID",
    "SCREENSCRAPER_DEV_PASSWORD", "OPENBOX_SCREENSCRAPER_DEV_PASSWORD",
    "STEAMGRIDDB_API_KEY", "OPENBOX_STEAMGRIDDB_API_KEY",
    "STRIPE_SECRET_KEY",
